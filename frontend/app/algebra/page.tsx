                ...
                <div className="relative w-[95vw] h-[80vh] z-20 bg-transparent text-white flex justify-center items-center rounded-[20px] border-3 border-white">
                    <div className="h-[75vh] w-[47.5vw] z-30 border-r-3 border-r-white flex flex-col items-end">
                        ...
                        {equationSelected === "linear1" && <textarea
                            className={`mx-auto p-6 bg-[rgba(249,249,88,0.3)] rounded-lg shadow-md w-[43vw] h-[30vh] text-[30px] placeholder:font-bold ${notoSansMath.className} placeholder:font-[Rajdhani] font-bold focus:ring-2 focus:ring-white`}
                        ...
                        {equationSelected === "quadratic" && <textarea
                            className={`mx-auto p-6 bg-[rgba(249,249,88,0.3)] rounded-lg shadow-md w-[43vw] h-[25vh] text-[30px] placeholder:font-bold ${notoSansMath.className} placeholder:font-[Rajdhani] font-bold focus:ring-2 focus:ring-white`}
                            placeholder="Enter your equation here."
                        ...
                        {equationSelected === "linear2" && <div className="flex w-[47vw] gap-[0.5vw] mx-auto justify-center items-center">
                            <textarea
                                className={`p-6 bg-[rgba(249,249,88,0.3)] rounded-lg shadow-md w-[21.5vw] h-[20vh] text-[30px] placeholder:font-bold ${notoSansMath.className} placeholder:font-[Rajdhani] font-bold focus:ring-1 focus:ring-white`}
                            ...
                            <textarea
                                className={`p-6 bg-[rgba(249,249,88,0.3)] rounded-lg shadow-md w-[21.6vw] h-[20vh] text-[30px] placeholder:font-bold ${notoSansMath.className} placeholder:font-[Rajdhani] font-bold focus:ring-1 focus:ring-white`}
